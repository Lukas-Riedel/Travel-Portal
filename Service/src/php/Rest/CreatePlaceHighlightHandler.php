<?php
    ...
    class CreatePlaceHighlightHandler extends Handler {
        public function handle($input) {
            ...
            $response = $highlightService->createPlaceHighlight($input["placeId"], $input["photoId"]);
        ...
        public function getPath() {
            return "/places/{placeId}/highlights";
        }
        ...
        public function getLongDescription() {
            return "Creates a highlight for the specified place.";
        }
