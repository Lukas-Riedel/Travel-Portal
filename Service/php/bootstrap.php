<?php
    ...
    $photoService = new PhotoService($databaseProvider, $googleApiClient, $configurationService, $eventPublisher);
    ...
    // Events consuming.
    $listeners = array(
        new CategoryServiceListener($categoryService, $eventPublisher, $scheduler),
