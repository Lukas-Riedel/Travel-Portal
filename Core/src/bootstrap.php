<?php
    ...
    use Core\Client\Cache\ExtendedRedisCacheClient;
    ...
    // Clients.
    $distributedCacheClient = new ExtendedRedisCacheClient(getenv("REDIS_HOST"), getenv("REDIS_PORT"), getenv("REDIS_PASSWORD"));
