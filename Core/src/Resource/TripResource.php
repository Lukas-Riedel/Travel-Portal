<?php
    ...
    class TripResource extends AbstractResource {
        ...
        #[OA\Post(
            path: "/trips/{tripId}/highlights/refresh",
            summary: "Refresh highlights for a trip with the specified identifier",
            operationId: "refreshTripHighlights",
            tags: ["Trips"],
            security: [ ["bearerAuth" => []] ],
            parameters: [
                new OA\Parameter(
        ...
        public function refreshTripHighlights(Request $request, Response $response, array $routeArguments) : mixed {
            $this->requireRole($request, UserRole::TripHighlightEdit);
