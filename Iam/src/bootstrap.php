<?php
    ...
    $googleService = new GoogleService($userService, $httpClient, $encryptionClient, $distributedCacheClient, getenv("FCM_PROJECT_ID"), getenv("FCM_PRIVATE_KEY_ID"), getenv("FCM_PRIVATE_KEY"), getenv("FCM_CLIENT_EMAIL"),
