...
ALTER TABLE album
ADD CONSTRAINT album_ibfk_1 FOREIGN KEY (id) REFERENCES album_identifier (id)$$

ALTER TABLE album
ADD CONSTRAINT album_ibfk_2 FOREIGN KEY (main_photo_id) REFERENCES photo_identifier (id) ON DELETE SET NULL$$

ALTER TABLE album_metadata
ADD CONSTRAINT album_metadata_ibfk_1 FOREIGN KEY (id) REFERENCES album_identifier (id) ON DELETE CASCADE$$

ALTER TABLE cache_point
ADD CONSTRAINT cache_point_ibfk_1 FOREIGN KEY (place_id) REFERENCES place_identifier (id) ON DELETE CASCADE$$

ALTER TABLE cache_statistics_category
ADD CONSTRAINT cache_statistics_category_ibfk_1 FOREIGN KEY (id) REFERENCES category_identifier (id) ON DELETE CASCADE$$

ALTER TABLE cache_statistics_trip
ADD CONSTRAINT cache_statistics_trip_ibfk_1 FOREIGN KEY (id) REFERENCES trip_identifier (id) ON DELETE CASCADE$$

ALTER TABLE category
ADD CONSTRAINT category_ibfk_1 FOREIGN KEY (place_id) REFERENCES place_identifier (id) ON DELETE CASCADE$$

ALTER TABLE category
ADD CONSTRAINT category_ibfk_2 FOREIGN KEY (category_id) REFERENCES category_identifier (id) ON DELETE CASCADE$$

ALTER TABLE category_identifier
ADD CONSTRAINT category_identifier_ibfk_1 FOREIGN KEY (main_highlight_id) REFERENCES highlight_category (highlight_id) ON DELETE SET NULL$$

ALTER TABLE expense
ADD CONSTRAINT expense_ibfk_2 FOREIGN KEY (trip_id) REFERENCES trip_identifier (id) ON DELETE CASCADE$$

ALTER TABLE expense
ADD CONSTRAINT expense_ibfk_3 FOREIGN KEY (subscription_id) REFERENCES expense_subscription (id) ON DELETE SET NULL$$
...
ADD CONSTRAINT flight_log_ibfk_1 FOREIGN KEY (from_airport_id) REFERENCES airport_identifier (id)$$

ALTER TABLE flight_log
ADD CONSTRAINT flight_log_ibfk_2 FOREIGN KEY (to_airport_id) REFERENCES airport_identifier (id)$$
...
ADD CONSTRAINT forecast_actual_ibfk_1 FOREIGN KEY (place_id) REFERENCES place_identifier (id) ON DELETE CASCADE$$

ALTER TABLE forecast_daylight
ADD CONSTRAINT forecast_daylight_ibfk_1 FOREIGN KEY (place_id) REFERENCES place_identifier (id) ON DELETE CASCADE$$

ALTER TABLE forecast_historical
ADD CONSTRAINT forecast_historical_ibfk_1 FOREIGN KEY (place_id) REFERENCES place_identifier (id) ON DELETE CASCADE$$

ALTER TABLE highlight_category
ADD CONSTRAINT highlight_category_ibfk_1 FOREIGN KEY (id) REFERENCES category_identifier (id) ON DELETE CASCADE$$

ALTER TABLE highlight_category
ADD CONSTRAINT highlight_category_ibfk_2 FOREIGN KEY (highlight_id) REFERENCES highlight_identifier (id) ON DELETE CASCADE$$

ALTER TABLE highlight_identifier
ADD CONSTRAINT highlight_identifier_ibfk_2 FOREIGN KEY (photo_id) REFERENCES photo_identifier (id) ON DELETE CASCADE$$

ALTER TABLE highlight_place
ADD CONSTRAINT highlight_place_ibfk_1 FOREIGN KEY (id) REFERENCES place_identifier (id) ON DELETE CASCADE$$

ALTER TABLE highlight_place
ADD CONSTRAINT highlight_place_ibfk_2 FOREIGN KEY (highlight_id) REFERENCES highlight_identifier (id) ON DELETE CASCADE$$

ALTER TABLE highlight_trip
ADD CONSTRAINT highlight_trip_ibfk_1 FOREIGN KEY (id) REFERENCES trip_identifier (id) ON DELETE CASCADE$$

ALTER TABLE highlight_trip
ADD CONSTRAINT highlight_trip_ibfk_2 FOREIGN KEY (highlight_id) REFERENCES highlight_identifier (id) ON DELETE CASCADE$$

ALTER TABLE highlight_year
ADD CONSTRAINT highlight_year_ibfk_1 FOREIGN KEY (highlight_id) REFERENCES highlight_identifier (id) ON DELETE CASCADE$$

ALTER TABLE note
ADD CONSTRAINT note_ibfk_1 FOREIGN KEY (trip_id) REFERENCES trip_identifier (id) ON DELETE CASCADE$$

ALTER TABLE photo
ADD CONSTRAINT photo_ibfk_1 FOREIGN KEY (album_id) REFERENCES album_identifier (id) ON DELETE CASCADE$$

ALTER TABLE photo
ADD CONSTRAINT photo_ibfk_2 FOREIGN KEY (id) REFERENCES photo_identifier (id)$$

ALTER TABLE photo_pending
ADD CONSTRAINT photo_pending_ibfk_1 FOREIGN KEY (album_id) REFERENCES album_identifier (id) ON DELETE CASCADE$$

ALTER TABLE place_candidate
ADD CONSTRAINT place_candidate_ibfk_1 FOREIGN KEY (place_id) REFERENCES place_identifier (id)$$

ALTER TABLE place_candidate_event
ADD CONSTRAINT place_candidate_event_ibfk_1 FOREIGN KEY (place_id) REFERENCES place_identifier (id)$$

ALTER TABLE place_candidate_event
ADD CONSTRAINT place_candidate_event_ibfk_2 FOREIGN KEY (trip_id) REFERENCES trip_identifier (id)$$

ALTER TABLE place_event
ADD CONSTRAINT place_event_ibfk_1 FOREIGN KEY (place_id) REFERENCES place_identifier (id)$$
...
ADD CONSTRAINT place_permanent_ibfk_1 FOREIGN KEY (place_id) REFERENCES place_identifier (id)$$

ALTER TABLE region_area
ADD CONSTRAINT region_area_ibfk_1 FOREIGN KEY (category_id) REFERENCES category_identifier (id) ON DELETE CASCADE$$

ALTER TABLE region_composite
ADD CONSTRAINT region_composite_ibfk_1 FOREIGN KEY (category_id) REFERENCES category_identifier (id)$$

ALTER TABLE region_composite
ADD CONSTRAINT region_composite_ibfk_2 FOREIGN KEY (subject_category_id) REFERENCES category_identifier (id)$$

ALTER TABLE region_geographical
ADD CONSTRAINT region_geographical_ibfk_1 FOREIGN KEY (category_id) REFERENCES category_identifier (id)$$
