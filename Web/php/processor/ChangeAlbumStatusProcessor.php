<?php
    ...
    class ChangeAlbumStatusProcessor extends Processor {    
        public function process($input) {
            ...
            return new Album($albumRow["id"], $albumRow["name"], $album["main_photo_id"], $albumRow["main_image_url"], $albumRow["permalink"], $albumRow["images_count"], $albumRow["indoor_images_count"],
