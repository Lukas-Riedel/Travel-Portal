<?php
    ...
    abstract class Handler {
        ...
        protected function create401ResponseExample() {
            return $this->createResponseExample("Missing authentication", 401, '{"code":401,"error":"The action can only be executed by authenticated users.","details":{"action":"AddAlbum","arguments":{"placeId":2507,"date":1589580000}}}');
        }
