<?php
    ...
    class CreateTripHighlightHandler extends Handler {
        ...
        public function getPath() {
            return "/trips/{tripId}/highlights";
        }
        ...
        public function getOperationId() {
            return "create_trip_highlight";
        }
        
        public function getShortDescription() {
            return "Create a highlight for the specified trip";
        }
        
        public function getLongDescription() {
            return "Creates a highlight for the specified trip.";
        }
