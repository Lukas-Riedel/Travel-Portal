<?php
    class GetPlaceHandler extends Handler {
        ...
        public function getLongDescription() {
            return "Retrieves a place with the specified identifier.";
        }
