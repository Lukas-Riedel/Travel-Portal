...
export interface UsePredefinedUserInputResult {
    ...
    showUpdateHighlightAttributesToast: (updateHighlightAttributes: (composition: number | null, sky: number | null, shadows: number | null, circumstances: number | null, atmosphere: number | null, impression: number | null) => Promise<Highlight>, highlightAttributes?: HighlightAttributes, timestamp?: number, timezone?: string, sunAltitude?: number) => Promise<boolean>
