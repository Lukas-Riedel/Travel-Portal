...
export interface UseUserInputResult {
    ...
    showFormToast: <F extends readonly (FormField<unknown> | undefined)[]> (message: string, fields: F, onSubmitted?: FormToastCallback<{ [K in keyof F]: F[K] extends FormField<infer T> ? T : never }>["onSubmitted"], success?: string, error?: string) => Promise<boolean>
