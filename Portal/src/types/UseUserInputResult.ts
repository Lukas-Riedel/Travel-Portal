...
export interface UseUserInputResult {
    ...
    showFormToast: <F extends readonly FormField<unknown>[], R> (message: string, fields: F, onSubmitted?: (...values: { [K in keyof F]: F[K] extends FormField<infer T> ? T : never }) => Promise<R>, success?: string, error?: string) => Promise<boolean>
