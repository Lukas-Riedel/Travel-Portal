...
export interface UseEventsResult {
    events?: Event[]
    publishHighlightsSelectingTriggeredEvent: (highlightType: HighlightType, entityId: string, highlightsCount: number, highlightsRemovalAllowed: boolean) => Promise<void>
