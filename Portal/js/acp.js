...
function getUtilitiesComponent(trip) {
    ...
    // Tools.
    const tools = [
        { name: "Aktualizovat alba", action: "createEvent('FetchAlbums', {})" },
        { name: "Aktualizovat kalendář", action: "createEvent('FetchTripsCalendar', { watchId: configuration.googleCalendarApi.watchId })" },
